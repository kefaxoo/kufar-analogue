...
class SignViewController: UIViewController {
    ...
    override func viewDidLoad() {
       ...
       private func setupLocalization() {
           ...
           signInButton.setTitle(Localization.Button.Title.signIn.rawValue.localized, for: .normal)
           signUpButton.setTitle(Localization.Button.Title.signUp.rawValue.localized, for: .normal)
           print("Локализация вызвалась")
       }
